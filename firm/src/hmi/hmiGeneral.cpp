...
void drawLadderEditorInstructionsNavigation(){
  ...
  tft.drawRoundRect(BORDER10, BUTTON_Y10, BUTTON_W10, BUTTON_H10, 8, COLOR_BUTTON_CANCEL_INSTRUC_EDITOR);
//  tft.fillRoundRect(BORDER10+1, BUTTON_Y10+1, BUTTON_W10-2, BUTTON_H10-2, 7, COLOR_BUTTON_CANCEL_INSTRUC_EDITOR);
  ...
  tft.drawRoundRect(BORDER10+BUTTON_W10+SPACING10, BUTTON_Y10, BUTTON_W10, BUTTON_H10, 8, COLOR_BUTTON_BACK_INSTRUC_EDITOR);
//  tft.fillRoundRect(BORDER10+BUTTON_W10+SPACING10+1, BUTTON_Y10+1, BUTTON_W10-2, BUTTON_H10-2, 7, COLOR_BUTTON_BACK_INSTRUC_EDITOR);
  ...
  tft.drawRoundRect(BORDER10+BUTTON_W10*2+SPACING10*2, BUTTON_Y10, BUTTON_W10, BUTTON_H10, 8, COLOR_BUTTON_ACCEPT_INSTRUC_EDITOR);
